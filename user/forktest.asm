...
forktest(void)
{
  ...
  36:	3b650513          	addi	a0,a0,950 # 3e8 <kbdint+0x8>
  ...
  58:	3e450513          	addi	a0,a0,996 # 438 <kbdint+0x58>
  ...
  6e:	38e50513          	addi	a0,a0,910 # 3f8 <kbdint+0x18>
  ...
  80:	39450513          	addi	a0,a0,916 # 410 <kbdint+0x30>
  ...
  b0:	37c50513          	addi	a0,a0,892 # 428 <kbdint+0x48>
