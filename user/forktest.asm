...
forktest(void)
{
  ...
  36:	3ce50513          	addi	a0,a0,974 # 400 <shutdown+0x8>
  ...
  58:	3fc50513          	addi	a0,a0,1020 # 450 <shutdown+0x58>
  ...
  6e:	3a650513          	addi	a0,a0,934 # 410 <shutdown+0x18>
  ...
  80:	3ac50513          	addi	a0,a0,940 # 428 <shutdown+0x30>
  ...
  b0:	39450513          	addi	a0,a0,916 # 440 <shutdown+0x48>
