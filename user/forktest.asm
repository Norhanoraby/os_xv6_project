...
forktest(void)
{
  ...
  36:	3de50513          	addi	a0,a0,990 # 410 <datetime+0x8>
  ...
  58:	40c50513          	addi	a0,a0,1036 # 460 <datetime+0x58>
  ...
  6e:	3b650513          	addi	a0,a0,950 # 420 <datetime+0x18>
  ...
  80:	3bc50513          	addi	a0,a0,956 # 438 <datetime+0x30>
  ...
  b0:	3a450513          	addi	a0,a0,932 # 450 <datetime+0x48>
