...
user/_keycount:     file format elf64-littleriscv
...
printf("%d", count);
  ...
  12:	85250513          	addi	a0,a0,-1966 # 860 <malloc+0x102>
  16:	694000ef          	jal	6aa <printf>
exit(0);
  1a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 372:	50250513          	addi	a0,a0,1282 # 870 <digits>
 376:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 608:	26cb8b93          	addi	s7,s7,620 # 870 <digits>
 ...
 656:	21690913          	addi	s2,s2,534 # 868 <malloc+0x10a>
        for(; *s; s++)
