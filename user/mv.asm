...
0000000000000000 <main>:
  ...
  1c:	8d850513          	addi	a0,a0,-1832 # 8f0 <malloc+0x120>
  20:	6fc000ef          	jal	71c <printf>
  24:	4505                	li	a0,1
  26:	2be000ef          	jal	2e4 <exit>
  2a:	00001597          	auipc	a1,0x1
  2e:	8a658593          	addi	a1,a1,-1882 # 8d0 <malloc+0x100>
  32:	6488                	ld	a0,8(s1)
  34:	074000ef          	jal	a8 <strcmp>
  38:	f165                	bnez	a0,18 <main+0x18>
  3a:	00001517          	auipc	a0,0x1
  3e:	89e50513          	addi	a0,a0,-1890 # 8d8 <malloc+0x108>
  42:	6da000ef          	jal	71c <printf>
  46:	4501                	li	a0,0
  ...
  6c:	8a850513          	addi	a0,a0,-1880 # 910 <malloc+0x140>
  70:	6ac000ef          	jal	71c <printf>
  74:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e4:	55850513          	addi	a0,a0,1368 # 938 <digits>
 3e8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 67a:	2c2b8b93          	addi	s7,s7,706 # 938 <digits>
 ...
 6c8:	26c90913          	addi	s2,s2,620 # 930 <malloc+0x160>
        for(; *s; s++)
