...
int main(int argc, char *argv[])
{
  ...
  20:	6e4000ef          	jal	704 <printf>
        exit(1);
  24:	4505                	li	a0,1
  26:	2be000ef          	jal	2e4 <exit>
    if(argc == 2 && strcmp(argv[1], "?") == 0){
  2a:	00001597          	auipc	a1,0x1
  2e:	88658593          	addi	a1,a1,-1914 # 8b0 <malloc+0xf8>
  32:	6488                	ld	a0,8(s1)
  34:	074000ef          	jal	a8 <strcmp>
  38:	f165                	bnez	a0,18 <main+0x18>
        printf("Usage: mv <src> <dest>\n");
  3a:	00001517          	auipc	a0,0x1
  3e:	87e50513          	addi	a0,a0,-1922 # 8b8 <malloc+0x100>
  42:	6c2000ef          	jal	704 <printf>
        exit(0);
  46:	4501                	li	a0,0
  ...
  6c:	88850513          	addi	a0,a0,-1912 # 8f0 <malloc+0x138>
  70:	694000ef          	jal	704 <printf>
        exit(1);
  74:	4505                	li	a0,1
