...
user/_rand:     file format elf64-littleriscv
...
int main(void)
{
   ...
   6:	0800                	addi	s0,sp,16
    int r = rand();
   8:	342000ef          	jal	34a <rand>
   c:	85aa                	mv	a1,a0
    printf("rand = %d\n", r);
   e:	00001517          	auipc	a0,0x1
  12:	87250513          	addi	a0,a0,-1934 # 880 <malloc+0x102>
  16:	6b4000ef          	jal	6ca <printf>
    exit(0);
  1a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 392:	50a50513          	addi	a0,a0,1290 # 898 <digits>
 396:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 676:	21e90913          	addi	s2,s2,542 # 890 <malloc+0x112>
        for(; *s; s++)
