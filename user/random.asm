...
user/_random:     file format elf64-littleriscv
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b2:	50a50513          	addi	a0,a0,1290 # 8b8 <digits>
 3b6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 648:	274b8b93          	addi	s7,s7,628 # 8b8 <digits>
 ...
 696:	21e90913          	addi	s2,s2,542 # 8b0 <malloc+0x112>
        for(; *s; s++)
