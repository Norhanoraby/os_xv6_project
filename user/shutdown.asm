...
main(void)
{
  ...
  1c:	88050513          	addi	a0,a0,-1920 # 898 <malloc+0x118>
  20:	6ac000ef          	jal	6cc <printf>
    exit(0);
  24:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 394:	54050513          	addi	a0,a0,1344 # 8d0 <digits>
 398:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 62a:	2aab8b93          	addi	s7,s7,682 # 8d0 <digits>
 ...
 678:	25490913          	addi	s2,s2,596 # 8c8 <malloc+0x148>
        for(; *s; s++)
