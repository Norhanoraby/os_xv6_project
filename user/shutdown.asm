...
main(void)
{
   ...
   c:	88850513          	addi	a0,a0,-1912 # 890 <malloc+0xf8>
  10:	6d4000ef          	jal	6e4 <printf>
    shutdown();
  ...
  1c:	89050513          	addi	a0,a0,-1904 # 8a8 <malloc+0x110>
  20:	6c4000ef          	jal	6e4 <printf>
    exit(0);
  24:	4501                	li	a0,0
