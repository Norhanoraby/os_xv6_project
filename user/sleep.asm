...
main(int argc, char *argv[])
{
  ...
  6c:	1000                	addi	s0,sp,32
    if (argc != 2) {
  6e:	4789                	li	a5,2
  70:	02f51863          	bne	a0,a5,a0 <main+0x3a>
  74:	e426                	sd	s1,8(sp)
    ...
    if (argv[1][0] == '-') {
  76:	6584                	ld	s1,8(a1)
  78:	0004c703          	lbu	a4,0(s1)
  7c:	02d00793          	li	a5,45
  80:	02f70a63          	beq	a4,a5,b4 <main+0x4e>
  ...
  84:	8526                	mv	a0,s1
  86:	f7bff0ef          	jal	0 <is_valid_positive_number>
  8a:	ed1d                	bnez	a0,c8 <main+0x62>
        printf("sleep: invalid time interval '%s'\n", argv[1]);
  8c:	85a6                	mv	a1,s1
  8e:	00001517          	auipc	a0,0x1
  92:	8d250513          	addi	a0,a0,-1838 # 960 <malloc+0x11a>
  96:	6fc000ef          	jal	792 <printf>
        exit(0);
  9a:	4501                	li	a0,0
  9c:	2a6000ef          	jal	342 <exit>
  a0:	e426                	sd	s1,8(sp)
        printf("Usage: sleep <positive number>\n");
  a2:	00001517          	auipc	a0,0x1
  a6:	89e50513          	addi	a0,a0,-1890 # 940 <malloc+0xfa>
  aa:	6e8000ef          	jal	792 <printf>
        exit(0);
  ae:	4501                	li	a0,0
  b0:	292000ef          	jal	342 <exit>
        printf("sleep: invalid time interval '%s'\n", argv[1]);
  b4:	85a6                	mv	a1,s1
  b6:	00001517          	auipc	a0,0x1
  ba:	8aa50513          	addi	a0,a0,-1878 # 960 <malloc+0x11a>
  be:	6d4000ef          	jal	792 <printf>
        exit(0);
  c2:	4501                	li	a0,0
  c4:	27e000ef          	jal	342 <exit>
    }
    
    int num1 = atoi(argv[1]);
  c8:	8526                	mv	a0,s1
  ca:	182000ef          	jal	24c <atoi>
    sleep(num1);
  ce:	304000ef          	jal	3d2 <sleep>
    exit(0);
  d2:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45a:	53a50513          	addi	a0,a0,1338 # 990 <digits>
 45e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f0:	2a4b8b93          	addi	s7,s7,676 # 990 <digits>
 ...
 73e:	24e90913          	addi	s2,s2,590 # 988 <malloc+0x142>
        for(; *s; s++)
