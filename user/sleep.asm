...
main(int argc, char *argv[])
{
  ...
  92:	8d250513          	addi	a0,a0,-1838 # 960 <malloc+0x122>
  96:	6f4000ef          	jal	78a <printf>
        exit(0);
  9a:	4501                	li	a0,0
  ...
  a6:	89e50513          	addi	a0,a0,-1890 # 940 <malloc+0x102>
  aa:	6e0000ef          	jal	78a <printf>
        exit(0);
  ae:	4501                	li	a0,0
  ...
  ba:	8aa50513          	addi	a0,a0,-1878 # 960 <malloc+0x122>
  be:	6cc000ef          	jal	78a <printf>
        exit(0);
  c2:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 452:	54250513          	addi	a0,a0,1346 # 990 <digits>
 456:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6e8:	2acb8b93          	addi	s7,s7,684 # 990 <digits>
 ...
 736:	25690913          	addi	s2,s2,598 # 988 <malloc+0x14a>
        for(; *s; s++)
