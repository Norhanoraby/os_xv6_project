...
printint(int fd, int xx, int base, int sgn)
{
 ...
 392:	4fa50513          	addi	a0,a0,1274 # 888 <digits>
 396:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 628:	264b8b93          	addi	s7,s7,612 # 888 <digits>
 ...
 676:	20e90913          	addi	s2,s2,526 # 880 <malloc+0x102>
        for(; *s; s++)
