...
print_help()
{
  ...
  18:	90c50513          	addi	a0,a0,-1780 # 920 <malloc+0x11e>
  1c:	732000ef          	jal	74e <printf>
    printf("Raises an error if the file already exists.\n");
  20:	00001517          	auipc	a0,0x1
  24:	93050513          	addi	a0,a0,-1744 # 950 <malloc+0x14e>
...
main(int argc, char *argv[])
{
  ...
  4a:	93a58593          	addi	a1,a1,-1734 # 980 <malloc+0x17e>
  4e:	8526                	mv	a0,s1
  ...
  66:	89e50513          	addi	a0,a0,-1890 # 900 <malloc+0xfe>
  6a:	6e4000ef          	jal	74e <printf>
        exit(1);
  6e:	4505                	li	a0,1
  ...
  8a:	90250513          	addi	a0,a0,-1790 # 988 <malloc+0x186>
  8e:	6c0000ef          	jal	74e <printf>
        exit(1);
  92:	4505                	li	a0,1
...
exit(0);
  ...
  b6:	8fe50513          	addi	a0,a0,-1794 # 9b0 <malloc+0x1ae>
  ba:	694000ef          	jal	74e <printf>
        exit(1);
  be:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 416:	5ce50513          	addi	a0,a0,1486 # 9e0 <digits>
 41a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ac:	338b8b93          	addi	s7,s7,824 # 9e0 <digits>
 ...
 6fa:	2e290913          	addi	s2,s2,738 # 9d8 <malloc+0x1d6>
        for(; *s; s++)
