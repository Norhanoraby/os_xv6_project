...
main(void)
{
  ...
  16:	88e50513          	addi	a0,a0,-1906 # 8a0 <malloc+0xfc>
  1a:	6d6000ef          	jal	6f0 <printf>
  ...
  28:	89c50513          	addi	a0,a0,-1892 # 8c0 <malloc+0x11c>
  2c:	6c4000ef          	jal	6f0 <printf>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 64e:	29eb8b93          	addi	s7,s7,670 # 8e8 <digits>
 ...
 69c:	24890913          	addi	s2,s2,584 # 8e0 <malloc+0x13c>
        for(; *s; s++)
